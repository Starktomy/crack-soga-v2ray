...
install_soga() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -N --no-check-certificate -O /usr/local/soga.tar.gz https://raw.githubusercontent.com/Starktomy/soga/master/soga.tar.gz
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://raw.githubusercontent.com/Starktomy/soga/master/soga.tar.gz"
